...
function wp_default_scripts( &$scripts ) {
	...
	//MASONRY
	//$scripts->add( 'masonry', "/wp-includes/js/masonry.pkgd.js", array(), '3.3.0', 1 );
	//$scripts->add( 'jquery-masonry', "/wp-includes/js/jquery/jquery.masonry$dev_suffix.js", array( 'jquery', 'masonry' ), '3.3.0', 1 );
